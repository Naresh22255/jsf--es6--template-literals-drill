...
const paragraph =
  "In auctor lobortis lacus. Phasellus gravida semper nisi. Fusce egestas elit eget lorem.";
...
const article = {
  title: "Latest news",
  intro:
    "Quisque malesuada placerat nisl. Donec orci lectus, aliquam ut, faucibus non, euismod id, nulla. Curabitur ullamcorper ultricies nisi. Quisque malesuada placerat nisl.",
...
string =
  "<div>Total people: " + (numberOfAdults() + numberOfChildren()) + "</div>";
